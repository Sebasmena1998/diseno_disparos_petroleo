...
def estimar_tiros_por_pie(penetracion):
    # Datos corregidos extraídos de la curva para RP = 1.0
    datos = {
        1:12,
        3: 8,
        4: 6,
...
while True:
    ...
    if respuesta_tiempo_exposicion == "si":
        ...
        TRAMO =9
        tiempo_exposicion= ((profundidad_base/TRAMO)*10)/60
...
#-------------- Calculos de RP -----------------------------------------
#--------------- Grafica de RP ----------------------------------------------
# Datos de la gráfica (aproximados visualmente, ajusta según necesites)
...
# Función para obtener RP desde beta_0
