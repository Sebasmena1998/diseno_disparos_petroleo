...
rD = ((rperf * (1 / 12)) / (2 * hperf))* (1 + math.sqrt(1 / ANISOTROPIA))
...
#RP_ecuación
re_metros=float(input("Inserte el radio de drene del pozo (re) metros: "))
re_pies= re_metros * 3.281
...
headers = [
    ...
    "Densidad de tiro (spf)", "Fase de tiro", "Penetración estimada - Thompson","Tipo de Carga", "Daño por disparos", "RP Gráfica", "RP Ecuación",
